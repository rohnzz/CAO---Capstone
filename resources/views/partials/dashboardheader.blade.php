...
<!-- Daterange picker -->
<link rel="stylesheet" href="{{ asset('frontend/frontend/plugins/daterangepicker/daterangepicker.css')}}">
<!-- summernote -->
<link rel="stylesheet" href="{{ asset('frontend/frontend/plugins/summernote/summernote-bs4.min.css')}}">
