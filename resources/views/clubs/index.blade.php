        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="shadow-primary border-radius-lg pt-4 pb-3" style="background: linear-gradient(195deg, #42a5f5, #1e88e5);">
                    <h6 class="text-white text-capitalize ps-3">Manage Clubs</h6>
                </div>
            </div>
            <div class="card-body px-0 pb-2">
                ...
                @endif
                <div class="d-flex justify-content-end mx-4 mb-2 gap-2">
                    <a href="{{ route('head-coaches.index') }}" class="btn btn-info">Manage Head Coaches</a>
                    ...
                    <table class="table align-items-center justify-content-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Head Coach</th>
                        ...
                        <tbody>
                            @forelse($clubs as $club)
                                <tr>
                                    ...
                                    <td><h6 class="mb-0 text-sm">{{ $club->name }}</h6></td>
                                    <td>{{ $club->headCoach ? $club->headCoach->name : 'None' }}</td>
                                    <td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center text-secondary text-sm">No Clubs Available</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
